...
const Layout = ({ onLogout, user }) => {
  ...
  return (
    <div className={styles.layout.root}>
      ...
      <Sidebar user={user} isCollapsed={sidebarCollapsed} setCollapsed={setSidebarCollapsed} />
      <div className={styles.layout.mainContainer(sidebarCollapsed)}>
        <div className={styles.header.container}>
          <div>
            <h1 className={styles.header.title}> Dashboard
            </h1>
          ...
          <div className={styles.statCards.card}>
            ...
            <p className={styles.statCards.cardFooter}>
              <span className="text-green-600 font-medium">
                +12.5%{/* Placeholder for income change percentage */}
                ...
                {displayedTransactions.map((transaction) => {
                  ...
                  return (
                    <div key={id} className={styles.transactions.transactionItem}>
                      <div className="flex items-center gap-1 md:gap-4 lg:ap-3">
                      ...
                      <span className={styles.colors.transaction.text(type)}></span>
